<template>
  ...
  <div class="mt-16">
    <form @submit.prevent="handleSubmit">
      <label class="block">
        <span class="text-lg font-medium text-gray">Nome</span>
        <input
          type="text"
      ...
      <label class="block mt-9">
        <span class="text-lg font-medium text-gray">E-mail</span>
        <input
          type="email"
          class="block w-full px-4 py-3 mt-1 text-lg bg-gray-100 border-2 border-transparent rounded"
      ...
      <label class="block mt-9">
        <span class="text-lg font-medium text-gray">Senha</span>
        <input
          type="password"
          class="block w-full px-4 py-3 mt-1 text-lg bg-gray-100 border-2 border-transparent rounded"
